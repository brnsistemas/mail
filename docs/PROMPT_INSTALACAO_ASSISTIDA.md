...
Use PHP 8.4, MySQL 8.4, Redis, ClamAV e dependências do composer.lock da revisão escolhida. Confira os requisitos de plataforma e o autoload. Nesta versão, o bootstrap exige MySQL isolado em 127.0.0.1:33461 e banco brnmail; não substitua pelo nome de serviço Docker ou por MariaDB sem revisar o contrato.
